...
import com.voxcast.activity.VoxcastController;
...
public class HttpRequest {
	...
	public static void getGetRequest(String url,final Context context,final ServerListner listner) {
		...
		try {
			...
			VoxcastController.getInstance().addToRequestQueue(sr);
		} catch (Exception e) {
	...
	public static  void getPostRequest(String url,
			final Context context,final ServerListner listner) throws JSONException {
...
//			System.out.println(par);
		JsonObjectRequest jsonObjectRequest=new JsonObjectRequest(Request.Method.POST,url, par,  new Response.Listener<JSONObject>() {
		...
		VoxcastController.getInstance().addToRequestQueue(jsonObjectRequest);
